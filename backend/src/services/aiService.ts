...
export async function analyzeStockWithAI(symbol: string, stockData: StockData): Promise<AIAnalysis> {
  try {
...
function createAnalysisPrompt(symbol: string, stockData: StockData): string {
...
function getMockAnalysis(symbol: string, stockData: StockData): AIAnalysis {
